...
func ({{ $FirstLetter }} *{{ $TableName }}) Select(query interface{}, args ...interface{}) *{{ $TableName }} {
	{{ $FirstLetter }}.db.Select(query, args...)
	return {{ $FirstLetter }}
}

func ({{ $FirstLetter }} *{{ $TableName }}) Unscoped() *{{ $TableName }} {
	{{ $FirstLetter }}.db.Unscoped()
	return {{ $FirstLetter }}
}
